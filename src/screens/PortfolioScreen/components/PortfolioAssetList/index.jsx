...
const PortfolioAssetsList = () => {
  ...
  // on delete asset from list and storage as well as from the global state of assets
  ...
  return (
    // Instead of flat list we can use this swiplist to swipe from left ans right to delete the asset
    <SwipeListView
      data={assets}
      renderItem={({ item }) => <PortfolioAssetsItem assetItem={item} />}
      rightOpenValue={-75} // it will stuck at 75% inorder display delete button
      disableRightSwipe
      closeOnRowPress
